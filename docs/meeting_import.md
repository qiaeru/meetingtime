...
| `timeboxMinutes` | whole number, 0 to 60 | No | Target duration of one speaking turn, in minutes. |
| `plannedDurationMinutes` | whole number, 0 to 600 | No | Planned total length of the meeting, in minutes. Drives the visual fill of the global timer. |
