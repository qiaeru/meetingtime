...
No automated test suite ships with this release. The app is real-time UI on top of a fairly small state machine; manual multi-participant scenarios (two browser windows) are the validation path.
