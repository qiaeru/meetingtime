...
The backend has zero native dependencies: Express 5, Socket.IO and Yjs are pure JavaScript, and there is no database. There is nothing to compile, no prebuilt binary to chase, and no toolchain to install beyond Node itself.
